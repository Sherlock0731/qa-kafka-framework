...
/**
 * Utility class for building Kafka client properties with common configurations.
 * 
 * <p>Eliminates code duplication between {@link KafkaProducerManager} and
 * {@link KafkaConsumerManager} by providing shared configuration logic for
 * SSL/TLS, authentication, and base properties.</p>
 * 
 * <p><b>Thread Safety:</b> All methods are static and stateless, safe for
 * concurrent use across multiple threads.</p>
 * 
 * <h3>Usage Example</h3>
 * <pre>{@code
 * // In ProducerManager
